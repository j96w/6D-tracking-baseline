...
class TSDFVolume(object):
    ...
    def __init__(self,vol_bnds,voxel_size):
        ...
        self._trunc_margin = self._voxel_size*1.0 # truncation on SDF
    ...
    def integrate(self,color_im,depth_im,cam_intr,cam_pose,obs_weight=1.):
        ...
        # CPU mode: integrate voxel volume (vectorized implementation)
            ...
            # pix_dep = np.zeros(pix_x.shape)
            # pix_dep[valid_pix] = cam_pts[2,valid_pix]

            # depth_val[abs(depth_val - pix_dep) > 0.10] = 0
